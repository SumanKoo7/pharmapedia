...
export const metadata: Metadata = {
  metadataBase: new URL("https://fast-bulldog-871.convex.cloud"), // Replace with your actual URL
  title: "Pharmapedia",
  description:
  ...
  openGraph: {
    ...
    url: "https://fast-bulldog-871.convex.cloud", // Replace with your actual URL
